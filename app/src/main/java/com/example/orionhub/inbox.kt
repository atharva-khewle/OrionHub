...
class inbox : Fragment() {
    ...
    private lateinit var adapter: AdapterForSearchviewForUsers
    ...
    override fun onCreateView(
        ...
        lifecycleScope.launch {
            val a = fireclass.getAllUsersList()
            if(a!=null){
...
//        adapter = AdapterforCommunityRecycler(mylist)
        adapter = AdapterForSearchviewForUsers(mylist) {
            openProfileFragment(it)
        }
